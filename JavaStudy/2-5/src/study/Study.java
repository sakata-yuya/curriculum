...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        ArrayList<String> shohinList = new ArrayList<String>() {
            {
                add(Study.SHOP_SHOHIN_00);
                add(Study.SHOP_SHOHIN_01);
                add(Study.SHOP_SHOHIN_02);
                add(Study.SHOP_SHOHIN_03);
        ...
        for (String s1 : shohinList) {
            System.out.println(s1+"="+shopMap.get(s1)+"になります！");
        }
