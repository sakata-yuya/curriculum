...
echo "機器やソフトウェア、システムを開発するために必要な機材やソフトウェアなどの組み合わせ、開発し終わってリリース予定の機能がちゃんと動くかテストするための環境、システムが製品として実際に稼動している環境"."<br>";
echo "2.基本設計書・詳細設計書"."<br>";
echo "ソフトウェアの動きを外から見た際にどういう動きをするのか、基本設計で決められた動きをどうやって実現するか"."<br>";
echo "3.Ajax"."<br>";
echo "JavaScriptを使用して行われる非同期処理のこと"."<br>";
